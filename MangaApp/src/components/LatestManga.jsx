...
import { getLatestManga, getMangaCover } from '../helpers/mangaApi';
...
export const LatestManga = () => {
  ...
  const fetchManga = async () => {
    try {
      const response = await getLatestManga(20 * page);
  ...
  return (
    <div style={{ backgroundColor: '#0037A5' }}>
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-white mb-6">Latest Updates</h1>
